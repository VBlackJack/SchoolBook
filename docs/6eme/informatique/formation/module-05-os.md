...
!!! example "L'OS, c'est comme un chef d'orchestre ! 🎼"
    ![OS = Chef d'orchestre](../../../assets/images/informatique/os-chef-orchestre.jpeg){ loading=lazy }

    L'OS coordonne tous les composants (CPU, RAM, disque, écran) pour que tout fonctionne ensemble !
...
!!! example "Les 3 OS en image 🖥️"
    ![Les 3 systèmes d'exploitation](../../../assets/images/informatique/os-trois-systemes.jpeg){ loading=lazy }

    Windows (75% des PC, jeux), macOS (Macs, design) et Linux (serveurs, gratuit) !
